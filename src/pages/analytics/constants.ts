...
export const layoutLG = [
  ...
  {
    i: STAKING_LOCK_BURNDOWN_AREA_CHART_ETHMAIN,
    x: 0,
    y: 40,
    w: 3,
    h: 4,
  ...
  {
    i: STAKING_LOCK_BURNDOWN_AREA_CHART_POLYGON,
    x: 3,
    y: 40,
    w: 3,
    h: 4,
  ...
  {
    i: STAKING_LOCK_BURNDOWN_AREA_CHART_FANTOM,
    x: 6,
    y: 40,
    w: 3,
    h: 4,
  ...
  {
    i: STAKING_LOCK_BURNDOWN_AREA_CHART_AURORA,
    x: 9,
    y: 40,
    w: 3,
    h: 4,
