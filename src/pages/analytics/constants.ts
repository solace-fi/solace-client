...
export const layoutSM = [
  ...
  { i: TOKEN_COMPOSITION_TABLE, x: 2, y: 1, w: 4, h: 4, minH: 3, maxH: 6, minW: 3, maxW: gridCols.sm },
...
export const layoutXS = [
  ...
  { i: TOKEN_COMPOSITION_TABLE, x: 1, y: 1, w: 3, h: 4, minH: 3, maxH: 6, minW: 3, maxW: gridCols.xs },
...
export const layoutXXS = [
  ...
  { i: MAX_EXPOSURE_STAT, x: 0, y: 1, w: gridCols.xxs, h: 1, isResizable: false },
