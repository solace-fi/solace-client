      ...
      <Flex col gap={20}>
        ...
        <Flex col gap={10}>
          ...
          <Accordion isOpen={tpvText} p={tpvText ? 5 : 0} noScroll>
            <Text>
              Value at risk is a measure of the risk of loss for a token in the underwriting pool. It estimates how much
              a might be lost, given normal market conditions, in a day. This is based on historical observations of
              token price changes.
            </Text>
          </Accordion>
