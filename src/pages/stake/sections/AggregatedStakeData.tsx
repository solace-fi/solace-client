      ...
      <Flex stretch gap={91} wrap mb={20} p={24}>
        ...
        <InfoPair importance="primary" label="Staked Balance">
          <CardSectionValue annotation="SOLACE">
            {truncateBalance(formatUnits(stakeData.stakedBalance, 18), 2)}
          </CardSectionValue>
        </InfoPair>
        <InfoPair importance="primary" label="Unlocked Balance">
          <CardSectionValue annotation="SOLACE">
            {truncateBalance(formatUnits(stakeData.unlockedBalance, 18), 2)}
          </CardSectionValue>
        </InfoPair>
        <InfoPair importance="primary" label="Locked Balance">
          <CardSectionValue annotation="SOLACE">
            {truncateBalance(formatUnits(stakeData.lockedBalance, 18), 2)}
          </CardSectionValue>
        </InfoPair>
        <InfoPair importance="primary" label="Total Rewards">
          <CardSectionValue annotation="SOLACE">
            {truncateBalance(formatUnits(stakeData.pendingRewards, 18), 2)}
          </CardSectionValue>
        </InfoPair>
        <VerticalSeparator />
