export const lightTheme = {
  ...
  input: {
    ...
    slider_color: 'rgb(94, 94, 94)',
  },
  modal: {
    bg_color: 'rgba(94, 94, 94, 0.9)',
    base_color: '#fff',
    glow: '0 0 7px #fff',
  },
  radio: {
